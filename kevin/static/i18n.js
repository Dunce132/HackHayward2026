...
const translations = {
  en: {
    ...
    voteSummary: "Who voted for what",
    alreadyInSession: "You're already in this session.",
  ...
  es: {
    ...
    voteSummary: "Quién votó por qué",
    alreadyInSession: "Ya estás en esta sesión.",
  ...
  fr: {
    ...
    voteSummary: "Qui a voté pour quoi",
    alreadyInSession: "Vous êtes déjà dans cette session.",
  ...
  hi: {
    ...
    voteSummary: "किसने किसके लिए वोट किया",
    alreadyInSession: "आप पहले से इस सत्र में हैं।",
